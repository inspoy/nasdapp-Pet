...
PetContract.prototype = {
    ...
    playWithPet: function () {
        ...
        if (currentTimeMillis - gameData.lastPlayTimeMillis < PLAY_INTERNAL) {
            throw new Error("玩耍间隔太短, " + (PLAY_INTERNAL - (currentTimeMillis - gameData.lastPlayTimeMillis))) + " 秒后可再次玩耍";
        }
    ...
    feedPet: function () {
        ...
        if (currentTimeMillis - gameData.lastFeedTimeMillis < FEED_INTERNAL) {
            throw new Error("喂食间隔太短, " + (FEED_INTERNAL - (currentTimeMillis - gameData.lastFeedTimeMillis))) + " 秒后可再次喂食";
        }
